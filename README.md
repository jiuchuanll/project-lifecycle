...
> [!IMPORTANT]
> This repository is open source, but version `0.3.1` remains a **pre-release
...
See [RELEASE-NOTES.md](RELEASE-NOTES.md) for the exact 0.3.1 candidate scope and upgrade notes.
