...
3. delivery verification and residual-risk handling are complete where delivery occurred, and each accepted closure is retained as a canonical bilingual closure-summary pair;
