...
Candidate version: `0.3.0`. Evidence status: `FAILED` based on retained `0.1.0` evidence for Codex `0.147.0-alpha.6.5`; see the root support matrix. Those traces are historical evidence, not validation of this candidate.
