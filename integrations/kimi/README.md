...
Candidate version: `0.5.0`. Evidence status: `FAILED` based on retained `0.1.0` evidence for Kimi Code `0.29.2`; see the root support matrix. Those traces are historical evidence, not validation of this candidate.
